...
// ← NEW
export const fetchWeaknesses = createAsyncThunk('sessions/fetchWeaknesses', async (_, thunkAPI) => {
    try {
...
export const sessionSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            // ← NEW: fetchWeaknesses cases
            .addCase(fetchWeaknesses.pending, (state) => { state.weaknessLoading = true; })
            .addCase(fetchWeaknesses.fulfilled, (state, action) => {
                state.weaknessLoading = false;
